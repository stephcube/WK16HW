...
public class DefaultJeepOrderDao implements JeepOrderDao {
      ...
      private NamedParameterJdbcTemplate jdbcTemplate;
        ...
        @Override
        public Order saveOrder(Customer customer, Jeep model, Color color, Engine engine, Tire tire, BigDecimal price, List<Option> options) {
            SqlParams params = generateInsertSql(customer, model, color, engine, tire, price);
